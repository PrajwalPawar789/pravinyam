    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography sx={{
          ...
          {props.subcategory == 'Array Initialisation' ? props.subcategory.substring(0, props.subcategory.indexOf(' ')) : props.subcategory == 'IF' ? props.subcategory.replace('IF', 'IF Statement') : props.subcategory}
        </Typography>
      </Box>
      <Typography
        sx={{
...
const Dryrun = () => {
  ...
  const [readerQues, setReaderQues] = useState([]);
  ...
  function getQuestions() {
    fetch("http://localhost:8090/api/exercises?module=reader")
      .then((result => {
  ...
  return (
    <Container maxWidth="100%" sx={{
          ...
          return (
            <Stack direction="row" alignItems="center" key={label} sx={{
              ...
              <Typography sx={{
                ...
                {label === 'All exercises' ? readerQues.length :
                  0}
              </Typography>
            </Stack>
          );
      ...
      <Box sx={{
        ...
        <Grid container>
          {
            readerQues.filter(item => item.title.match(new RegExp(query, 'i')))
              .map((prop) => {
                return (

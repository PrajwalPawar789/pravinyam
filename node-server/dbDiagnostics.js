...
async function runDiagnostics() {
    ...
    var moduleNames = [];
    let customQuery = "SELECT module from public.modulemaster WHERE module NOT IN (select module from public.cexercises)";
    try {
    ...
    customQuery = "SELECT exid FROM public.cexercises where TRIM(exid) NOT in (select DISTINCT exid from public.cqadata)";
    try {
    ...
    var exWithNoCode = [];
    customQuery = "SELECT exid FROM public.cexercises where qlocation is NULL";
    try {
    ...
    var codeLocation = [];
    customQuery = "SELECT qlocation FROM public.cexercises";
    try {
